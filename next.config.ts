...
const nextConfig: NextConfig = {
  ...
  // motion v12 CJS/ESM interop with Webpack — transpilePackage
  // ensures the library is processed by next-swc/swc-loader so
  // shared chunks created by dynamic imports resolve correctly.
