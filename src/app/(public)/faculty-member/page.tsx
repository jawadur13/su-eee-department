...
export const metadata = {
  ...
  description:
    'Faculty members of the Department of Electrical and Electronics Engineering, Sonargaon University — Dean, Head of Department, full-time and part-time faculty.',
};
