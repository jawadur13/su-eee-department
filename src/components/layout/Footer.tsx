    ...
    <footer className="bg-primary text-white pt-16 pb-8 relative overflow-hidden">
      ...
      <Container>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10 lg:gap-8 mb-12">
          ...
          {/* Mobile pairing — Quick Link + Campuses (mirrors the Useful
              Link / Get in Touch pair above, so all 4 link columns
              show as a 2x2 grid on mobile instead of Quick Link and
              Campuses each falling onto their own full-width row). */}
          <div className="grid grid-cols-2 gap-6 md:contents">
            <div>
